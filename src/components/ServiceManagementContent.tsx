...
const ServiceManagementContent: React.FC<ServiceManagementContentProps> = ({ onServicesUpdate }) => {
    ...
    <>
      ...
      <div className="tab-content">
        {activeServiceTab === 'services' ? (
                ...
                <div className="form-group">
                  ...
                  <div style={{ position: 'relative' }}>
                    <input 
                      ...
                      onChange={(e) => setServiceTypeFormData(prev => ({ ...prev, icon: e.target.value }))}
                        ...
                        {availableIcons.map((icon) => (
                          <button
                            ...
                            style={{
                              ...
                              padding: '8px',
                              border: 'none',
                              background: serviceTypeFormData.icon === icon ? '#f0f9ff' : 'transparent',
                              borderRadius: '4px',
                              cursor: 'pointer'
                            }}
                          >
          ...
          <div className="services-list-section">
            <h4>Tipos de Serviços Cadastrados ({serviceTypes.length})</h4>
            <div className="services-list">
              {serviceTypes.length > 0 ? (
                serviceTypes.map((serviceType) => (
                  <div key={serviceType.id} className="service-item">
                    <div className="service-info">
                      <div className="service-name">
                        <span style={{ fontSize: '24px', marginRight: '8px' }}>{serviceType.icon}</span>
                        {serviceType.name}
                      </div>
                      {serviceType.description && (
                        <div className="service-details" style={{ color: '#6b7280' }}>
                          {serviceType.description}
                        </div>
                      )}
                      <div className="service-schedule">
                        ...
                        <span style={{ marginLeft: '12px', color: serviceType.active ? '#22c55e' : '#ef4444' }}>
